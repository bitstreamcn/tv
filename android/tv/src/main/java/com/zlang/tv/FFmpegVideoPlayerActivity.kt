...
class FFmpegVideoPlayerActivity : ComponentActivity() {
    companion object {
        ...
        var instance : FFmpegVideoPlayerActivity? = null

        // 创建启动Activity的Intent
        fun createIntent(context: Context, path: String, startPosition: Long, serverIp: String, ffmpeg: Boolean): Intent {
            return Intent(context, FFmpegVideoPlayerActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ffmpeg_video_player)
    ...
    private fun startPlaying() {
        try {
            ...
            val dataSourceFactory = TcpDataSource.Factory(serverIp, true)
    ...
    private fun savePlaybackPosition(videoPath: String, position: Long) {
        try {
            ...
            MainActivity.instance?.updatePlayRecord(videoPath, position, videoDuration, true)
        } catch (e: Exception) {
